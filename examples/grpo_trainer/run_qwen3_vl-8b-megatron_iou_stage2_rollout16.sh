...
train_path=/apdcephfs_tj5/share_303570626/xianyihe/datasets/final/nocot/train_final_2k.parquet
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    trainer.project_name='verl_grpo_miou2k_rollout8_qae_nocot' \
    trainer.experiment_name='qwen3_vl_8b_grpo_highclip0_28_2k' \
