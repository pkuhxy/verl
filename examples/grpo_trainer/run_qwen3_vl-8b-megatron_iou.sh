...
train_path=/apdcephfs_nj7/share_1220751/xianyihe/dataset/TencentARC/TimeLens-100K/train_2000.parquet
test_path=/apdcephfs_nj7/share_1220751/xianyihe/dataset/TencentARC/TimeLens-100K/test.parquet
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    trainer.project_name='verl_grpo_miou2k' \
    trainer.experiment_name='qwen3_vl_8b_megatron_grpo_3' \
