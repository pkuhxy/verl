...
train_path=/apdcephfs_nj7/share_1220751/xianyihe/dataset/TencentARC/TimeLens-100K/stage1/metadata/train_random_mask_1000.parquet
test_path=/apdcephfs_nj7/share_1220751/xianyihe/dataset/TencentARC/TimeLens-100K/stage1/metadata/test.parquet
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    actor_rollout_ref.ref.log_prob_max_token_len_per_gpu=4608 \
    actor_rollout_ref.rollout.log_prob_use_dynamic_bsz=True \
    actor_rollout_ref.rollout.log_prob_max_token_len_per_gpu=4608 \
    ...
    trainer.project_name='verl_grpo_miou2k_stage1' \
    trainer.experiment_name='qwen3_vl_8b_grpo_highclip0_28' \
