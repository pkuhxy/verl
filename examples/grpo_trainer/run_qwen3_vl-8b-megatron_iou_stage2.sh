...
# NCCL network configuration for multi-node communication
# export NCCL_DEBUG=INFO
# export NCCL_DEBUG_SUBSYS=INIT,NET
# export NCCL_TIMEOUT=1800
# export NCCL_SOCKET_IFNAME=bond1  # Use bond1 for inter-node communication (same as Ray cluster)
# export TORCH_NCCL_BLOCKING_WAIT=1
# export TORCH_DISTRIBUTED_DEBUG=INFO

# If using InfiniBand, uncomment the following:
...
CKPT_DIR="/apdcephfs_tj5/share_303570626/xianyihe/verl/checkpoints/verl_grpo_miou2k_stage2_rollout16_qae_nocot/qwen3_vl_8b_grpo_highclip0_28_nocot_qae07"
...
train_path=/apdcephfs_tj5/share_303570626/xianyihe/datasets/vtg_stage2_RL/metadata/stage2_train.parquet
test_path=/apdcephfs_tj5/share_303570626/xianyihe/datasets/vtg_stage2_RL/metadata/stage2_test.parquet
...
python3 -m verl.trainer.main_ppo --config-path=config \
    ...
    trainer.project_name='verl_grpo_miou2k_stage2_qae' \
    trainer.experiment_name='qwen3_vl_8b_grpo_highclip0_28_rollout8_bsz4' \
